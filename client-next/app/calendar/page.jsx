                                ...
                                <div style={{ flex: 1, display: 'flex' }}>
                                    {['Monday 1', 'Tuesday 2', 'Wednesday 3', 'Thursday 4', 'Friday 5', 'Saturday 6', 'Sunday 7'].map((day, index) => (
                                        <div key={day} style={{ flex: 1, borderLeft: '1px solid #f0f0f0', display: 'flex', flexDirection: 'column' }}>
                                            ...
                                            <div style={{ flex: 1, position: 'relative', background: index === 3 ? '#fafafa' : 'transparent' }}>
                                                {index === 0 && (
                                ...
                                {Array.from({ length: 35 }).map((_, i) => {
                                    ...
                                    return (
                                        <div key={i} style={{ background: '#fff', minHeight: '100px', padding: '8px', position: 'relative' }}>
                                            <div style={{ textAlign: 'right', color: isCurrentMonth ? (isToday ? '#fff' : '#333') : '#ccc' }}>
                                                <span style={{ background: isToday ? '#111' : 'transparent', borderRadius: '50%', width: '24px', height: '24px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                                                    {dayNum > 0 && dayNum <= 31 ? dayNum : (dayNum <= 0 ? 31 + dayNum : dayNum - 31)}
                                                </span>
                                            </div>
                                            {isCurrentMonth && dayNum === 1 && <div style={{ background: '#e0f2fe', color: '#0369a1', fontSize: '0.65rem', padding: '2px 5px', borderRadius: '4px', marginTop: '5px' }}>Course 1 Exam</div>}
