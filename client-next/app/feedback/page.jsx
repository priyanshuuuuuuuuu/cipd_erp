                        ...
                        <>
                            <div style={{ background: '#fff', borderRadius: '10px', border: '1px solid #e8e8e8', padding: '0', marginBottom: '1.2rem', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.02)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', padding: '10px 1.2rem', fontSize: '0.78rem', borderBottom: '1px solid #f0f0f0', overflowX: 'auto', whiteSpace: 'nowrap' }}>
                                    {[['Course','CS301'],['Lecture Date','16 Feb 2026']].map(([l,v])=>(
                            ...
                            {formOpen && !submitted && (
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '1.2rem' }}>
                                    <div style={{ background: '#fff', borderRadius: '10px', border: '1px solid #e8e8e8', boxShadow: '0 1px 4px rgba(0,0,0,0.02)', overflow: 'hidden' }}>
                                        ...
                                        <div style={{ padding: '1.2rem 1.5rem' }}>
                                            ...
                                            <div style={{ display:'flex',justifyContent:'flex-end',paddingTop:'8px',borderTop:'1px solid #f0f0f0' }}>
                                                <button onClick={handleSubmit} disabled={!canSubmit} style={{ display:'flex',alignItems:'center',gap:'6px',padding:'8px 20px',borderRadius:'8px',border:'none',background:canSubmit?'#111':'#e5e7eb',color:canSubmit?'#fff':'#aaa',fontSize:'0.82rem',fontWeight:600,cursor:canSubmit?'pointer':'not-allowed' }}>
                                    ...
                                    <div style={{ display:'flex',flexDirection:'column',gap:'1rem' }}>
                                        {[['Submission Info',[['Status','Pending'],['Full Credit','+20 pts'],['Late Penalty','−5 pts/hr'],['Deadline','23:59 today'],['Mandatory','5 of 6']]],['Your Progress',[['Streak','7 lectures'],['Total Credits','140 pts'],['Submissions','12 / 14'],['Avg Rating Given','3.8'],['Rank','#6 of 38']]]].map(([title,rows])=>(
                                ...
                                <div style={{ background:'#fff',borderRadius:'10px',border:'1px solid #e8e8e8',boxShadow:'0 1px 4px rgba(0,0,0,0.02)',overflow:'hidden',maxWidth:'640px' }}>
                                    ...
                                    <div style={{ padding:'1.2rem 1.5rem' }}>
                                        <div style={{ display:'flex',flexDirection:'column',gap:'10px',fontSize:'0.85rem' }}>
                                            {[['Status','Submitted ✓'],['Credits Earned','+20'],['Current Streak','7 Lectures'],['Engagement Percentile','Top 18%'],['Submitted At',new Date().toLocaleTimeString('en-IN',{hour:'2-digit',minute:'2-digit'})]].map(([label,val],i)=>(
                        ...
                        <>
                            <div style={{ background:'#fff',borderRadius:'10px',border:'1px solid #e8e8e8',padding:'0',marginBottom:'1.2rem',overflow:'hidden',boxShadow:'0 1px 4px rgba(0,0,0,0.02)' }}>
                                <div style={{ display:'flex',alignItems:'center',padding:'10px 1.2rem',fontSize:'0.78rem',overflowX:'auto',whiteSpace:'nowrap' }}>
                                    {[['Course','CS301'],['Your Rank','#6'],['Your Credits','140'],['Percentile','Top 18%'],['Streak','7']].map(([l,v],i)=>(
                            ...
                            <div style={{ background:'#fff',borderRadius:'10px',border:'1px solid #e8e8e8',boxShadow:'0 1px 4px rgba(0,0,0,0.02)',overflow:'hidden' }}>
                                <div style={{ display:'flex',justifyContent:'space-between',alignItems:'center',padding:'10px 1.2rem',borderBottom:'1px solid #f0f0f0' }}>
                                    <div style={{ display:'flex',alignItems:'center',gap:'8px' }}><Trophy size={14} color="#888" /><span style={{ fontSize:'0.88rem',fontWeight:700,color:'#111' }}>Engagement Leaderboard — CS301</span></div>
                                ...
                                <div style={{ padding:'8px 1.2rem',background:'#fafafa',fontSize:'0.68rem',color:'#aaa',borderTop:'1px solid #f0f0f0' }}>Showing top 10 of 38 students · Rankings update after each lecture feedback submission</div>
                            </div>
                        </>
                    )}
                </div>
