...
DO $$
BEGIN
  -- Try to add mcq value; ignore if it already exists
  ALTER TYPE feedback_question_type ADD VALUE IF NOT EXISTS 'mcq';
EXCEPTION WHEN others THEN
  RAISE NOTICE 'mcq value already exists or enum issue, skipping';
END $$;

-- 3. Clear old questions and seed the full feedback form (18 questions)
